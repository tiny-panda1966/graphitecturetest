...
const Section6 = {
    ...
    _getRuleKey() {
        ...
        if (type.includes('training')) {
            return orderState.trainingType === 'bespoke'
                ? 'football-training-bespoke'
                : 'football-training';
        }
    ...
    getDeliveryOptions() {
        ...
        return {
            ...
            stdLabel: `Standard Delivery — Free (${rule.stdDays}${rule.stdDays.toLowerCase().includes('week') ? '' : ' days'})`,
            ...
            <div class="delivery-options">
                <div class="delivery-card delivery-card--info">
                    ...
                    <div class="delivery-card-detail">
                        <span class="delivery-days">${opts.stdDays.toLowerCase().includes('week') ? opts.stdDays : opts.stdDays + ' Days'}</span>
                    </div>
                </div>
        `;
        ...
        if (opts.expLabel) {
            html += `
                <p style="margin-top:10px;font-size:11px;color:var(--text-muted);text-align:center;">
                    Submit for Approval — A member of the team will be in contact.
                </p>
            `;
        }
