            ...
            {allProjects.map(function(proj) {
              ...
              return React.createElement("div", { key: proj.id },
                React.createElement("div", {
                  style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 4, cursor: "pointer", padding: "4px 0" },
                  ...
                  React.createElement("div", { style: { width: 160, flexShrink: 0, overflow: "hidden" } },
                    React.createElement("div", { style: { fontSize: 11, fontWeight: 500, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", display: "flex", alignItems: "center", gap: 4 } },
                      React.createElement("span", { style: { fontSize: 9, color: "#999", transition: "transform 0.2s", transform: isExpanded ? "rotate(90deg)" : "rotate(0)", display: "inline-block" } }, "▶"),
                      proj.info.project
                    ),
                    React.createElement("div", { style: { fontSize: 9, color: "#999", paddingLeft: 14 } }, proj.info.customer + " · " + fmtDateShort(projDates.end))
                  ),
                  React.createElement("div", { style: { flex: 1, position: "relative", height: 22, background: "#f8f8f8", borderRadius: 4 } },
          ...
          <div style={s.card}>
            <div style={{ padding: "0 0 4px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 0, minHeight: 200 }}>
                {weekDays.map(function(d, di) {
                  var work = getWorkForDay(d.date);
                  return React.createElement("div", { key: di, style: { padding: "8px 6px", borderRight: di < 6 ? "1px solid #f0f0f0" : "none", background: d.isToday ? "rgba(0,0,0,0.02)" : d.isWeekend ? "#fafafa" : "transparent" } },
                    ...
                    work.map(function(w, wi) {
                      ...
                      return React.createElement("div", { key: wi, style: { marginBottom: 6, padding: "6px 8px", borderRadius: 6, border: "1px solid #eee", background: "#fff", fontSize: 10 } },
