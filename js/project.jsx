  ...
  return (
    <div className="page-container">
      ...
      <div className="grid-4">
        ...
        <StatCard value={fmt(st.matCost)} label="Material Cost" />
      </div>
      ...
      <div className="grid-2">
        ...
        <div style={s.card}>
          ...
          <div style={s.cardBody}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0 0", borderTop: "1px solid #eee", marginTop: 8, fontSize: 12 }}>
              <span>Materials</span><span style={{ fontWeight: 500 }}>{fmt(st.matCost)}</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", padding: "4px 0", fontSize: 12 }}>
              <span>Labour</span><span style={{ fontWeight: 500 }}>{fmt(labCost)}</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", padding: "10px 0 0", borderTop: "2px solid #111", marginTop: 4, fontSize: 16 }}>
              <span style={{ fontWeight: 500 }}>Total (ex. VAT)</span><span style={{ fontWeight: 500 }}>{fmt(st.matCost + labCost)}</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", padding: "4px 0", fontSize: 12, color: "#888" }}>
              <span>inc. VAT (20%)</span><span>{fmt((st.matCost + labCost) * 1.2)}</span>
            </div>
          </div>
        </div>
      </div>
